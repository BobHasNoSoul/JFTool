...
do
	...
	echo ""
	sudo cp ./mods/10.4/forcebackdrops.10.4.js /usr/lib/jellyfin/bin/jellyfin-web/components/usersettings/usersettingsbuilder.js
    sudo cp ./mods/10.5/forcedbackdrops.10.5.js /usr/lib/jellyfin/bin/jellyfin-web/scripts/settings/userSettingsBuilder.js
	;;
	...
	echo "to clear itself and reload the .js file we will load in"
	echo ""
	sudo cp ./mods/10.4/usersettingsbuilder.10.4.js /usr/lib/jellyfin/bin/jellyfin-web/components/usersettings/usersettingsbuilder.js
    sudo cp ./mods/10.5/userSettingsBuilder.10.5.js /usr/lib/jellyfin/bin/jellyfin-web/scripts/settings/userSettingsBuilder.js
	;;
	...
	sudo cp ./mods/10.4/trailertab/*.js /usr/lib/jellyfin/bin/jellyfin-web/controllers/movies
	...
	echo ""
	sudo cp ./mods/10.4/stock/moviesrecommended.js /usr/lib/jellyfin/bin/jellyfin-web/controllers/movies/
	sudo cp ./mods/10.4/stock/movietrailers.js /usr/lib/jellyfin/bin/jellyfin-web/controllers/movies/
	;;
	...
	echo ""
	echo "now we will copy the files"
	sudo cp ./mods/10.5/trailertab/*.js /usr/lib/jellyfin/bin/jellyfin-web/controllers/movies
	echo "finished copying files"
	echo ""
	echo "Please Input the URL of your ombi install (e.g. domain.com/ombi without https:// or http://) :"
    read ombiurl2
	...
	echo "This will restore the stock files for movietrailers.js and moviesrecommended.js making the tab go to the trailers plugin"
	echo ""
	sudo cp ./mods/10.5/stock/moviesrecommended.js /usr/lib/jellyfin/bin/jellyfin-web/controllers/movies/
	sudo cp ./mods/10.5/stock/movietrailers.js /usr/lib/jellyfin/bin/jellyfin-web/controllers/movies/
	;;
	"Quit")
	  break
	  ;;
