...
do
    ...
    "Two custom link in side bar")
      ...
      sed -i "s~TOPLINKICONHERE~$customlinkicon1~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~TOPLINKNAMEHERE~$customlinkname1~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
	  sed -i "s~2NDLINKHERE~$customlink2~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~2NDLINKICONHERE~$customlinkicon2~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~2NDLINKNAMEHERE~$customlinkname2~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
	  ;;
    "Three custom link in side bar")
      ...
      sed -i "s~2NDLINKICONHERE~$customlinkicon2~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~2NDLINKNAMEHERE~$customlinkname2~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
	  sed -i "s~3RDLINKHERE~$customlink3~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~3RDLINKICONHERE~$customlinkicon3~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~3RDLINKNAMEHERE~$customlinkname3~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
   	 ;;
	 "Four custom link in side bar")
      ...
      sed -i "s~3RDLINKICONHERE~$customlinkicon3~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~3RDLINKNAMEHERE~$customlinkname3~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
	  sed -i "s~4THLINKHERE~$customlink4~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~4THLINKICONHERE~$customlinkicon4~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
      sed -i "s~4THLINKNAMEHERE~$customlinkname4~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
   	 ;;
	...
	"Change Page Title")
	  ...
	  sed -i "s~$currenttitle~$newtitle~g" /cygdrive/c/Docker/jellyfin/jellyfin-web/main.bundle.js
   ...
   "add Dynamic login background")
    ...
    scriptkey="</script>"
    sed -i "s|${scriptkey}| \
    ${loginbackjs}|g" /cygdrive/c/Docker/jellyfin/jellyfin-web/index.html
