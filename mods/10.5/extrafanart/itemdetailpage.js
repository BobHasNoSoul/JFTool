    ...
    function renderScenes(page, item) {
       ...
       var test = page.querySelector("#scenesCollapsible");
             if (images)
                ...
                test.innerHTML += '<a href="/emby/Items/' + item.Id + '/Images/Primary/" target="_blank"> <img src="/emby/Items/' + item.Id + '/Images/Primary/' + i + '?maxWidth=150' + '&quality=90"' + 'hspace="20" onerror="this.style.display='+"'none'"+'"/></a><a href="/emby/Items/' + item.Id + '/Images/Art/" target="_blank"> <img src="/emby/Items/' + item.Id + '/Images/Art/' + i + '?maxWidth=150' + '&quality=90"' + 'hspace="20" onerror="this.style.display='+"'none'"+'"/></a><a href="/emby/Items/' + item.Id + '/Images/Logo/" target="_blank"> <img src="/emby/Items/' + item.Id + '/Images/Logo/' + i + '?maxWidth=150' + '&quality=90"' + 'hspace="20" onerror="this.style.display='+"'none'"+'"/></a><a href="/emby/Items/' + item.Id + '/Images/Disc/" target="_blank"><img src="/emby/Items/' + item.Id + '/Images/Disc/' + i + '?maxWidth=150' + '&quality=90"' + 'hspace="35" onerror="this.style.display='+"'none'"+'"/></a><a href="/emby/Items/' + item.Id + '/Images/Backdrop/" target="_blank"><img src="/emby/Items/' + item.Id + '/Images/Backdrop/' + i + '?maxWidth=150' + '&quality=90"' + 'hspace="35" onerror="this.style.display='+"'none'"+'"/></a><a href="/emby/Items/' + item.Id + '/Images/Banner/" target="_blank"><img src="/emby/Items/' + item.Id + '/Images/Banner/' + i + '?maxWidth=150' + '&quality=90"' + 'hspace="35" onerror="this.style.display='+"'none'"+'"/></a><a href="/emby/Items/' + item.Id + '/Images/Box/" target="_blank"><img src="/emby/Items/' + item.Id + '/Images/Box/' + i + '?maxWidth=150' + '&quality=90"' + 'hspace="35" onerror="this.style.display='+"'none'"+'"/></a>';
                };
    }
