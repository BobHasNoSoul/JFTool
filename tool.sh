...
echo ""
echo "Jellyfin Customizer v3.0 -- LINUX"
echo ""
...
do
    ...
    "Two custom link in side bar")
	  ...
	  sudo sed -i "s~TOPLINKHERE~$customlink3~g" /usr/share/jellyfin/web/scripts/libraryMenu.js
      sudo sed -i "s~TOPLINKICONHERE~$customlinkicon1~g" /usr/share/jellyfin/web/scripts/libraryMenu.js
      sudo sed -i "s~TOPLINKNAMEHERE~$customlinkname1~g" /usr/share/jellyfin/web/scripts/libraryMenu.js
	  sudo sed -i "s~2NDLINKHERE~$customlink3~g" /usr/share/jellyfin/web/scripts/libraryMenu.js
...
#	  ;; 
#	"Add snow animation")
	  # sudo cp ./animation/videoosd.css.fix /usr/share/jellyfin/web/assets/css/videoosd.css
	  # sudo cp ./animation/stylefix.css /usr/share/jellyfin/web/components/htmlvideoplayer/style.css	
	  ...
	  # ;;
	# "Add Heart animation")
      # sudo cp ./animation/videoosd104.css.fix /usr/share/jellyfin/web/css/videoosd.css
	  # sudo cp ./animation/videoosd.css.fix /usr/share/jellyfin/web/assets/css/videoosd.css
	  # sudo cp ./animation/stylefix.css /usr/share/jellyfin/web/components/htmlvideoplayer/style.css	
	...
	# "Add Fireworks")
      ...
      # sudo cp ./animation/sitefix10.4.css /usr/share/jellyfin/web/css/site.css
      # sudo cp ./animation/sitefix10.5.css /usr/share/jellyfin/web/assets/css/site.css
    ...
    # "Add Pattys day")
      ...
      # ;;
	# "Remove Animations")
	  # sudo cp ./animation/videoosd104.css.original /usr/share/jellyfin/web/css/videoosd.css
	  # sudo cp ./animation/videoosd.css.original /usr/share/jellyfin/web/assets/css/videoosd.css
	  # sudo cp ./animation/stylestock.css /usr/share/jellyfin/web/components/htmlvideoplayer/style.css	
	  # sudo cp ./animation/stockify.html /usr/share/jellyfin/web/index.html
