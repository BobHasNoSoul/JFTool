...
do
	...
	"Add logo above login")
	  ...
	  logowhite='<img src="/web/logowhite.png" width=400px style="padding: 5px;display:block; margin-left: auto; margin-right: auto;">'
          ...
          <div class="Login-Logo">" "/cygdrive/c/Docker/jellyfin/jellyfin-web/login.html"
          sed -i "/Login-Logo/a \
          ${logowhite}" "/cygdrive/c/Docker/jellyfin/jellyfin-web/login.html"
	  sed -i "/logowhite.png/a \
	  </div>" "/cygdrive/c/Docker/jellyfin/jellyfin-web/login.html"
